...
{
public:
	NdexcodeError(string msgIn, ErrorPriority priorityIn, Token tokenIn=nullptr);
...
//typedef shared_ptr<NdexcodeError> Err;

//Err makeError(string msgIn, ErrorPriority priorityIn, Token tokenIn=nullptr) {return Err(new NdexcodeError(msgIn, priorityIn, tokenIn));}
