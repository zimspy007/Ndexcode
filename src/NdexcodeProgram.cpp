...
NdexcodeProgram::NdexcodeProgram()
{

}

void NdexcodeProgram::cleanUp()
{

}

void NdexcodeProgram::resolveProgram(string inFilename, bool printOutput)
{
	AllOperators::init();
	populateNdexcodeStdLib();
